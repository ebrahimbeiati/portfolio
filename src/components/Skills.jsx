...
const Skills = () => {
  return (
    <div
      name="skills"
      className="w-full bg-slate-700 text-gray-300 text-center text-bold py-2"
    >
      {/*container*/}
      ...
      <div className="w-full p-4 grid grid-cols-4 sm:grid-cols-4 gap-4 text-center py-10">
